...
var AddBooksComponent = /** @class */ (function () {
    ...
    AddBooksComponent.prototype.newBook = function () {
        this.submitted = false;
        this.book = new _model_book_model__WEBPACK_IMPORTED_MODULE_2__["Book"]();
    };
    AddBooksComponent.prototype.save = function () {
    ...
    AddBooksComponent.ctorParameters = function () { return [
...
var BooksDetailsComponent = /** @class */ (function () {
    function BooksDetailsComponent(bookService, listComponent) {
        this.bookService = bookService;
        this.listComponent = listComponent;
    }
    BooksDetailsComponent.prototype.ngOnInit = function () {
    };
    BooksDetailsComponent.ctorParameters = function () { return [
...
var BooksListComponent = /** @class */ (function () {
    ...
    BooksListComponent.prototype.reloadData = function () {
    ...
    BooksListComponent.prototype.getBook = function (id) {
        var _this = this;
    ...
    BooksListComponent.ctorParameters = function () { return [
...
var BooksListingService = /** @class */ (function () {
    function BooksListingService(http) {
        this.http = http;
        this.baseUrl = '/books';
        this.listUrl = '/list';
    }
    BooksListingService.prototype.getBook = function (id) {
        return this.http.get(this.baseUrl + "/" + id);
    };
    BooksListingService.prototype.addBook = function (book) {
        return this.http.post("" + this.baseUrl, book);
    };
    BooksListingService.prototype.updateBook = function (id, value) {
        return this.http.put(this.baseUrl + "/" + id, value);
    };
    BooksListingService.prototype.deleteBook = function (id) {
        return this.http.delete(this.baseUrl + "/" + id, { responseType: 'text' });
    };
    BooksListingService.prototype.getAllBooks = function () {
        return this.http.get("" + this.baseUrl + this.listUrl);
    };
    BooksListingService.ctorParameters = function () { return [
